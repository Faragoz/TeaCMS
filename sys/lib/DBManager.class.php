...
class DBManager
{
    ...
    public function __construct($host, $username, $password, $db, $port = NULL)
    {
        ...
        $this->_mysqli = new mysqli($host, $username, $password, $db, $port)
            or die('Ocurrió un problema al conectarse a la base de datos');
     ...
     * @param bool   $nr         Return num_rows or not...
     *
     * @return array Contains the returned rows from the query and if you want the num_rows.
     */
    public function rawQuery($query, $bindParams = null, $nr = false)
    {
        ...
        $data[] = $this->_dynamicBindResults($stmt);
