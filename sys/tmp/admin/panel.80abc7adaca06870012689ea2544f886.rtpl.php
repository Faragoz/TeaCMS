...
<body>
	...
	<section id="main" class="column">
		...
		<h4 class="alert_info">Bienvenido a la administración <?php echo htmlspecialchars( $user["username"], ENT_COMPAT, 'UTF-8', FALSE ); ?>, recuerda que el panel está en construcción...</h4>

		<?php require $this->checkTemplate("widgets/box/instructions");?>

		
		<?php require $this->checkTemplate("widgets/box/stats");?>


		<?php require $this->checkTemplate("widgets/box/messages");?>
