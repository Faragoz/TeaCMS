<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="box">
    <?php if( $news["id"] ){ ?>
        ...
        <div data-role="news">
            <div>
                <div>
                    <img author-look src="http://www.habbohotel.es/habbo-imaging/avatarimage?figure=<?php echo htmlspecialchars( $news["look"], ENT_COMPAT, 'UTF-8', FALSE ); ?>&direction=2&head_direction=3&gesture=sml&action=&size=l">
                </div>
                <div>
